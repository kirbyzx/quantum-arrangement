...
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhead[R]{Quantum annealing for music arrangement}
\fancyhead[L]{Lucas Kirby}
...
\begin{align}
    ...
    &-C\sum_{v \in V}\sum_{i=1}^n W_{v,v}x_{v,i}-D\sum_{(uv)\in E}W_{uv}\sum_{i=1}^n\sum_{i<j}^n x_{u,i}x_{v,j}\notag\\
    &-E\sum_{v \in V}\sum_{i=1}^n\theta(W_{vv}-W_{\text{th},i})x_{v,i}
...
\newlength{\scorewidth}
\setlength{\scorewidth}{.88\textwidth}

\begin{figure}[ht]
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\scorewidth,page=1]{haydn-op1.pdf}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\scorewidth,page=1]{haydn-arr.pdf}
...
\begin{figure}[ht]
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\scorewidth,page=1]{beethoven-op67.pdf}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\scorewidth,page=1]{beethoven-arr.pdf}
        \caption{Constructed arrangement from solution, bars 1--21. Note that, due to the nature of the reconstruction, the music may be poorly formatted and incomplete.}
    \end{subfigure}
